...
void MainMenu::onInitialize()
{
	...
	menu[0].setPosition(sf::Vector2f(width / 3, height / (MAX_NUMBER_OF_ITEMS + 1) * 0.2));

	menu[1].setString("Single Player");
	menu[1].setColor(sf::Color::Red);
	menu[1].setCharacterSize(40);
	menu[1].setPosition(sf::Vector2f(width / 3, height / (MAX_NUMBER_OF_ITEMS + 1) * 1.7));

	menu[2].setString("Multiplayer");
	menu[2].setColor(sf::Color::White);
	menu[2].setCharacterSize(40);
	menu[2].setPosition(sf::Vector2f(width / 3, height / (MAX_NUMBER_OF_ITEMS + 1) * 2.7));

	menu[3].setString("Inverse Tetris");
	menu[3].setColor(sf::Color::White);
	menu[3].setCharacterSize(40);
	menu[3].setPosition(sf::Vector2f(width / 3, height / (MAX_NUMBER_OF_ITEMS + 1) * 3.7));

	menu[4].setString("Options");
	menu[4].setColor(sf::Color::White);
	menu[4].setCharacterSize(40);
	menu[4].setPosition(sf::Vector2f(width / 3, height / (MAX_NUMBER_OF_ITEMS + 1) * 4.7));

	menu[5].setString("Quit");
	menu[5].setColor(sf::Color::White);
	menu[5].setCharacterSize(40);
	menu[5].setPosition(sf::Vector2f(width / 3, height / (MAX_NUMBER_OF_ITEMS + 1) * 5.7));
